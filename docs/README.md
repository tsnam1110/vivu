...
- [`what-to-eat-next-plan.md`](features/what-to-eat-next-plan.md) — **Kế hoạch sprint What to Eat** (S0–S5, checklist task)
...
- [`what-to-eat-fact-completion-plan.md`](features/what-to-eat-fact-completion-plan.md) — Kế hoạch data dài fact món (tầng 0–6)
...
- [`agent-prompts/what-to-eat/`](agent-prompts/what-to-eat/) — **Prompt từng task** What to Eat (copy sang Agent khác)
